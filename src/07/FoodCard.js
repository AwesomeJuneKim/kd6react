...
export default function FoodCard({fObj}) {
  ...
  return (
    ...
    <div className='flex flex-row border-2 border-solid
                    w-11/12 justify-center items-center'>
        <img src={fimg} alt={bank} className='w-1/6 max-w-30 min-w-20'/>
        <div className='flex flex-col justify-center w-5/6 mx-3'>
            ...
            <div className='w-full text-white bg-slate-600 mt-5 p-2' onClick={handleClick}>
